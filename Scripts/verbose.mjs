 ...
 */
  ...
  get verbose() {
    ...
    return this.#currentLogName ?
      this.#getSetting(this.#currentLogName) :
      true;
  }
   ...
   */
  log(...params) {
    logs.addLog(this.#currentLogName, logs.serveriety.LOG, ...params);
    if (!this.verbose) return;
    const prefix = this.#currentLogName ? [`%cVERBOSE_${this.#currentLogName}:%c`, `color: ${this.#currentColour || 'black'}`, ''] : [];
   ...
   */
  warn(...params) {
    logs.addLog(this.#currentLogName, logs.serveriety.WARN, ...params);
    if (!this.verbose) return;
    const prefix = this.#currentLogName ? [`%cVERBOSE_${this.#currentLogName}:%c`, `color: ${this.#currentColour || 'black'}`, ''] : [];
   ...
   */
  error(...params) {
    logs.addLog(this.#currentLogName, logs.serveriety.ERROR, ...params);
    if (!this.verbose) return;
    const prefix = this.#currentLogName ? [`%cVERBOSE_${this.#currentLogName}:%c`, `color: ${this.#currentColour || 'black'}`, ''] : [];
   ...
   */
  info(...params) {
    logs.addLog(this.#currentLogName, logs.serveriety.INFO, ...params);
    if (!this.verbose) return;
    const prefix = this.#currentLogName ? [`%cVERBOSE_${this.#currentLogName}:%c`, `color: ${this.#currentColour || 'black'}`, ''] : [];
   ...
   */
  debug(...params) {
    logs.addLog(this.#currentLogName, logs.serveriety.DEBUG, ...params);
    if (!this.verbose) return;
    const prefix = this.#currentLogName ? [`%cVERBOSE_${this.#currentLogName}:%c`, `color: ${this.#currentColour || 'black'}`, ''] : [];
   ...
   */
  trace(...params) {
    logs.addLog(this.#currentLogName, logs.serveriety.TRACE, ...params);
    if (!this.verbose) return;
    const prefix = this.#currentLogName ? [`%cVERBOSE_${this.#currentLogName}:%c`, `color: ${this.#currentColour || 'black'}`, ''] : [];
   ...
   */
  dir(...params) {
    logs.addLog(this.#currentLogName, logs.serveriety.DIR, ...params);
    if (!this.verbose) return;
    console.dir(...params);
  }
   ...
   */
  table(...params) {
    logs.addLog(this.#currentLogName, logs.serveriety.TABLE, ...params);
    if (!this.verbose) return;
